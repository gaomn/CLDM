    ...
    def update(self):
        ...
        for i in range(self.iter_num):
            for part in self.Particle_list:
                ...
                pop.append([copy.copy(part.get_pos()), copy.copy(part.get_fitness_value())])
                x_list.append(copy.copy(part.get_pos()))
                fit_list.append(copy.copy(part.get_fitness_value()))
