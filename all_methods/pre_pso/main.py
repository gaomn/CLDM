...
from dtp_base.demo import Our_method, Optimal, PSO_only, SQL_, SQL_0, TPLPSO, PSO_Pre
import os
...
def run_data():
    ...
    # name_ = 'p1_con_lsc_b=0-100'
    # with open(f'data_{name_}.pkl', 'wb') as file:
    #     pickle.dump(data_dict, file)
    # with open(f'id_{name_}.pkl', 'wb') as file:
    #     pickle.dump(id_dict, file)
    #
    # with open(f'data_{name_}.pkl', 'rb') as file:
    #     loaded_dict = pickle.load(file)
    # with open(f'id_{name_}.pkl', 'rb') as file:
