...
def set_param():
    ...
    parser.add_argument('--mode', default='sqlpso', type=str, help="'pxm', 'kxm', 'k2xm', 'kfxim', 'kfxsm', 'kfdxim'")
    ...
    parser.add_argument('--lambda_', default=0., type=float)
    ...
    parser.add_argument('--lambda_list', default=[0.], type=list)
    parser.add_argument('--b_list', default=[10, 50, 100], type=list)
    parser.add_argument('--bt_type_list', default=['linear', 'cir'], type=str, help="'linear', 'sin', 'cir'")
    parser.add_argument('--bt_change', default='discrete', type=str, help="discrete, continuous")
    parser.add_argument('--sample_num', default=30, type=int)
