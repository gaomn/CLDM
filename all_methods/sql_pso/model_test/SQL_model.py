...
class Model:
    ...
    def modeling(self, state, t):
        ...
        plt.savefig(self.args.fig_filename + f'/ste p_model(b={self.args.time_fac})_{t}.jpg')
    ...
    def updating(self, state, t_cur):
        ...
        for temp_t, lt in self.Lt.items():
            ...
            if self.args.if_plot:
                ...
                plt.xlabel(r'x_1 Value', fontsize=18)
                plt.ylabel('value', fontsize=18)
                plt.title(f'predict step={temp_t} / {t_cur} || (b={self.args.time_fac})', fontsize=18)
    ...
    def get_Lt(self, t, pso_dict):
        ...
        state = pso_dict['state']
        x_lst = copy.deepcopy(pso_dict['x_list'])
        f_lst = copy.deepcopy(pso_dict['fit_list'])
    ...
    def get_max_q(self, state):
        ...
        for t_temp, lt_temp in self.Lt.items():
            ...
            print_list.append((if_choose, d_, self.Lt_qm[t_temp],lt_temp['S']))
        if num > 0.:
            q_max = qm / num
        else:
